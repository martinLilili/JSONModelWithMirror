...
public extension MirrorResult {
    
    public func getResultFromMirror(mir : Mirror, action: (_ label: String?, _ value : Any) -> Void) {
...
//MARK: - JSON协议
//自定义一个JSON协议
public protocol JSON: MirrorResult {
...
//得到所有的属性即value
public protocol PropertieValues: MirrorResult {
...
public extension PropertieValues {
    ...
    ///
    /// - Returns: dic
    public func codablePropertieValues() -> [String:AnyObject] {
